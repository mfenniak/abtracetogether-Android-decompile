...
public final class ForUseFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
    ...
    return paramLayoutInflater.inflate(2131492925, paramViewGroup, false);
  }
  
  public void onViewCreated(View paramView, Bundle paramBundle) {
    Intrinsics.checkParameterIsNotNull(paramView, "view");
    super.onViewCreated(paramView, paramBundle);
    LinearLayout linearLayout = (LinearLayout)_$_findCachedViewById(R.id.forUseFragmentActionButton);
    if (linearLayout != null)
      linearLayout.setOnClickListener(new ForUseFragment$onViewCreated$1()); 
  }
  
  @Metadata(bv = {1, 0, 3}, d1 = {"\000\020\n\000\n\002\020\002\n\000\n\002\030\002\n\002\b\002\020\000\032\0020\0012\016\020\002\032\n \004*\004\030\0010\0030\003H\n¢\006\002\b\005"}, d2 = {"<anonymous>", "", "it", "Landroid/view/View;", "kotlin.jvm.PlatformType", "onClick"}, k = 3, mv = {1, 1, 16})
  static final class ForUseFragment$onViewCreated$1 implements View.OnClickListener {
    public final void onClick(View param1View) {
      Fragment fragment = ForUseFragment.this.getParentFragment();
      if (fragment != null) {
        ((ForUseByOTCFragment)fragment).goToUploadFragment();
        return;
      } 
...
/* Location:              /Users/mfenniak/Development/decompile/tmp/classes-dex2jar.jar!/ca/albertahealthservices/contacttracing/fragment/ForUseFragment.class
