...
public final class CentralDevice implements Parcelable {
  ...
  public CentralDevice(String paramString1, String paramString2) {
    this.modelC = paramString1;
  ...
  public final CentralDevice copy(String paramString1, String paramString2) {
    Intrinsics.checkParameterIsNotNull(paramString1, "modelC");
    return new CentralDevice(paramString1, paramString2);
  }
  ...
  public boolean equals(Object paramObject) {
    if (this != paramObject) {
      if (paramObject instanceof CentralDevice) {
        paramObject = paramObject;
        if (Intrinsics.areEqual(this.modelC, ((CentralDevice)paramObject).modelC) && Intrinsics.areEqual(this.address, ((CentralDevice)paramObject).address))
          return true; 
      } 
      return false;
    } 
  ...
  public String toString() {
    ...
    stringBuilder.append("CentralDevice(modelC=");
    stringBuilder.append(this.modelC);
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt) {
    ...
    paramParcel.writeString(this.modelC);
  ...
  public static final class Creator implements Parcelable.Creator {
    public final Object createFromParcel(Parcel param1Parcel) {
      ...
      return new CentralDevice(param1Parcel.readString(), param1Parcel.readString());
    }
    
    public final Object[] newArray(int param1Int) {
      return (Object[])new CentralDevice[param1Int];
    }
  }
}


/* Location:              /Users/mfenniak/Development/decompile/tmp/classes-dex2jar.jar!/ca/albertahealthservices/contacttracing/streetpass/CentralDevice.class
